...
> [!NOTE]
> This service is **no longer part of the active Escruta ecosystem**. Document extraction is now provided by [Helper](https://github.com/escruta/helper) (`POST /extract`). This repository is kept for archival purposes only.
...
The extraction service will be available at [localhost:8000](http://localhost:8000).
