...
The extraction service will be available at [localhost:8000](http://localhost:8000). It is consumed by [Core](../core) at this URL (configured via `ESCRUTA_EXTRACTOR_URL`).
